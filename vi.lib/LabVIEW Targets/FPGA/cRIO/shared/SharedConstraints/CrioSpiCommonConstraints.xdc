...
#..............................................................................#
#Common Constraints for SPI Modules. FUNC is used only for mode change, so
#it doesn't get constrained with SPI numbers. These constraints assume that 
#either CrioCommInt or CrioStock are used.

#The common Constraints assume that the module uses SPI as its main 
#communication protocol, where SpiClk, Conv_n, MOSI and Cs_n are dedicated 
#to SPI output, MISO is dedicated to SPI Input, Func Done, Trig and OClk are 
#only used for asynchronous Input or Output. 
...
set CrioSpiPinsSLOTNUM [get_ports {CRIOPIN_Mosi CRIOPIN_Cs_n CRIOPIN_Conv_n}]
set CrioAsyncInputPinsSLOTNUM [get_ports {CRIOPIN_IdSel CRIOPIN_Done_n CRIOPIN_Trig CRIOPIN_OClk CRIOPIN_Func}]
set CrioAsyncOutputPinsSLOTNUM [get_ports {CRIOPIN_IdSel CRIOPIN_Func CRIOPIN_Trig CRIOPIN_Done_n CRIOPIN_OClk CRIOPIN_Mosi CRIOPIN_Cs_n CRIOPIN_Conv_n CRIOPIN_Func CRIOPIN_SpiClk}]
...
#        OUTPUT PINS         #
#............................#
#Get all the SPI Pins Drivers, we assume that the Convert SPI Driver is not 
#part of the commint or stock, so we grab all the drivers and the one that
#doesn't belong to commint or stock is the convert driver
